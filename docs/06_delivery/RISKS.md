...
| R-017 | Retention and deletion remain undefined before real use | Privacy and operational risk | Keep open and resolve applicable retention/deletion rules before real-student data collection in Stage B | Owner open; blocking for real data |
