...
public final class ClassroomCommandApplicationService {
    ...
    public ClassroomCommandExecution execute(ClassroomCommandRequest request) {
        ...
        if (existing.isPresent()) {
            ...
            return new ClassroomCommandExecution(result(outcome), false);
        }
        ...
        return new ClassroomCommandExecution(result(outcome), true);
    }
